      ...
      <div className="container mx-auto px-3 sm:px-4 max-w-7xl">
                ...
                <div className="p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center gap-2 text-blue-800">
                    ...
                    <div>
                      ...
                      <div className="text-xs">Est. 1-7 working days</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden mb-4 sm:mb-6">
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            {activeTab === 'delivery' && (
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Delivery Information</h3>
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Free Standard Delivery</h4>
                      <p className="text-gray-600 text-xs sm:text-sm">Delivered within 1-7 working days to your doorstep.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Express Delivery</h4>
                      <p className="text-gray-600 text-xs sm:text-sm">Next day delivery available for urgent orders (additional charges apply).</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Secure Packaging</h4>
                      <p className="text-gray-600 text-xs sm:text-sm">All products are carefully packaged to ensure safe delivery.</p>
                    </div>
                  </div>
                </div>
              </div>
